...
function borrarDatos()
{
	...
	mysql_query("truncate table actor",$link);
...
function insertarDatos($id, $nombre)
{
	...
	// Insertamos los datos en la base de datos
	mysql_query("INSERT INTO actor (id,nombre) VALUES ('$id','$nombre')",$link);
...
while (!feof($ar))
  {    
	...
	$i=$i+1;
    //Guardamos los actores en la base de datos
